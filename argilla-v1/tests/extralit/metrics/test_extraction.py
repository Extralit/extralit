...
from extralit_v1.metrics.extraction import grits_paper

if TYPE_CHECKING:
    from extralit_v1.extraction.models.paper import PaperExtraction


def test_grits_paper_with_pred_missing_column(
    mock_paper_extraction_true: "PaperExtraction", mock_paper_extraction_pred: "PaperExtraction"
):
...
def test_grits_paper_with_pred_missing_column_reversed(
    mock_paper_extraction_true: "PaperExtraction", mock_paper_extraction_pred: "PaperExtraction"
):
