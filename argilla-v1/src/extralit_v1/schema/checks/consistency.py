...
def check_less_than(
    ...
    *,
    ...
    or_equal: Union[bool, List[str]] = False,
) -> pd.Series:
    """
    ...
    assert (
        len(columns_a) == len(columns_b) == len(or_equal)
...
def check_between(
    ...
    *,
    ...
    or_equal: Union[bool, List[str]] = True,
) -> pd.Series:
    """
    ...
    assert (
        len(columns_target) == len(columns_lower) == len(columns_upper) == len(or_equal)
