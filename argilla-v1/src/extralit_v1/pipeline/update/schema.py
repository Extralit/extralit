...
def update_record_table_schema(
    record: rg.FeedbackRecord, schema: pa.DataFrameSchema, field: str, answer: Optional[str] = None
) -> rg.FeedbackRecord:
    ...
    try:
        record.fields[field] = update_table_schema(
            record.fields[field], schema_json=schema_json, reference=reference, schema_name=schema_name
        )
