...
def create_extraction_prompt(schema: pa.DataFrameSchema, extractions: PaperExtraction, filter_unique_cols=False) -> str:
    prompt = (
    ...
    for dep_schema_name in dependencies:
        ...
        schema_json = get_extraction_schema_model(
            schema_structure[dep_schema_name],
