...
from extralit_v1.extraction.vector_store import WeaviateVectorStore, create_default_schema
...
def get_storage_context(
    ...
    if weaviate_client:
        ...
        vector_store = WeaviateVectorStore(weaviate_client=weaviate_client, index_name=index_name, text_key="text")
