<template>
  <div class="import-file-upload">
    ...
    <div class="import-file-upload__content">
      <div class="import-file-upload__sections">
        ...
        <div class="import-file-upload__section">
          <div class="import-file-upload__section-header">
            <h4 class="import-file-upload__section-title">
              <BaseIcon icon-name="document" class="import-file-upload__section-icon" />
              Bibliography File
            </h4>
            <p class="import-file-upload__section-description">
              Upload a .bib file exported from your reference manager
            </p>
          </div>
          ...
          >
            <input ref="bibFileInput" type="file" accept=".bib,.bibtex" style="display: none" @change="handleBibFileSelect" />
          ...
          <div v-if="bibUploaded && !bibHasError" class="import-file-upload__success">
            <BaseIcon icon-name="check" class="import-file-upload__success-icon" />
            <div class="import-file-upload__success-content">
              <h4>Bibliography Parsed Successfully</h4>
              <p>{{ bibData.fileName }} - {{ bibData.parsedEntries.length }} references found</p>
            </div>
          </div>
        ...
        <div class="import-file-upload__section">
          ...
          >
            ...
            <div class="import-file-upload__dropzone-content">
              ...
              <p class="import-file-upload__dropzone-subtext">
                Click to select a folder containing PDF files
              </p>
            </div>
          </div>
          ...
          <div v-if="pdfProcessing" class="import-file-upload__progress">
            ...
            <div class="import-file-upload__progress-bar">
              <div
                class="import-file-upload__progress-fill"
                :style="{ width: `${pdfProgressPercentage}%` }"
              ></div>
            </div>
          </div>

          <!-- PDF Success Display -->
          <div v-if="pdfUploaded && !pdfHasError && !pdfProcessing" class="import-file-upload__success">
            <BaseIcon icon-name="check" class="import-file-upload__success-icon" />
            <div class="import-file-upload__success-content">
              <h4>PDF Files Processed Successfully</h4>
              <p>{{ pdfData.matchedFiles.length }} matched, {{ pdfData.unmatchedFiles.length }} unmatched</p>
            </div>
          </div>
...
!-- Combined Preview Section -->
      <div v-if="bibUploaded && pdfUploaded && !bibHasError && !pdfHasError && !pdfProcessing" class="import-file-upload__preview">
            ...
            <table class="import-file-upload__table">
              ...
              <tbody>
                <tr v-for="match in previewMatches" :key="match.bibEntry.reference">
                  ...
                  <td class="import-file-upload__table-cell--title">{{ match.bibEntry.title || "N/A" }}</td>
                  ...
                  <td class="import-file-upload__table-cell--match">
                    <span
                      class="import-file-upload__match-badge"
...
export default {
  ...
  computed: {
    ...
    getBibDropzoneText() {
      ...
      if (this.bibUploaded) return `${this.bibData.fileName} uploaded successfully`;
    ...
    getPdfDropzoneText() {
      ...
      if (this.pdfUploaded) return `${this.pdfData.totalFiles} PDF files processed`;
      return "Select folder containing PDF files";
    },
