<template>
  <div class="import-upload">
    <div class="import-upload__header">
      ...
      <p class="import-upload__description">
        Upload a .bib file to import your reference library into this workspace
      </p>
    </div>
      ...
      <div class="import-upload__file-section">
        ...
        >
          ...
          <div class="import-upload__dropzone-content">
            <BaseIcon
              :icon-name="getDropzoneIcon"
              class="import-upload__dropzone-icon"
            />
