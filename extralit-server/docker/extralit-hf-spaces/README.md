...
> This Docker image corresponds to the **Extralit Hugging Face Spaces deployment** and **can only be used to deploy Extralit inside the Hugging Face Hub**. For other type of deployments check the Extralit docs.
