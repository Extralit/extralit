...
class PyMuPDFExtractionClient:
    ...
    async def extract_markdown(
        ...
        try:
            ...
            error_msg = f"Request error to PyMuPDF service: {str(e)}"
            _LOGGER.error(error_msg)
            raise ValueError(error_msg) from e
    ...
    async def health_check(self) -> bool:
        ...
        try:
            ...
            _LOGGER.warning(f"PyMuPDF service health check failed: {str(e)}")
            return False
...
async def extract_pdf_text(
    ...
    try:
        ...
        _LOGGER.error(f"PyMuPDF text extraction failed for {filename}: {str(e)}")
...
async def check_service_health() -> bool:
    ...
    try:
        ...
        _LOGGER.warning(f"Service health check failed: {str(e)}")
        return False
