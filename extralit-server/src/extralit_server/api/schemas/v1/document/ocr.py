...
class ExtractionRequest(BaseModel):
    ...
    file_url: Optional[str] = Field(None, description="Optional URL to the PDF file if hosted externally")
    analysis_metadata: Optional[PDFMetadata] = Field(
        None, description="Analysis and preprocessing metadata from extralit-server"
    )
    extraction_config: Optional[dict[str, Any]] = Field(None, description="Custom extraction configuration parameters")
