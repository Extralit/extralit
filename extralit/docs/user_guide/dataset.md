...
!!! info
    If you have deployed Extralit with Hugging Face Spaces and HF Sign in, you can use `extralit` as a workspace name. Otherwise, you might need to create a workspace following [this guide](workspace.md#create-a-new-workspace).
