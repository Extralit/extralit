...
1. Start a local instance of Extralit, easiest by just using the docker recipe [here](../getting_started/how-to-deploy-extralit-with-docker.md). It will give you a backend API for the frontend.
