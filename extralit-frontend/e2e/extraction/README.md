# extraction e2e suite (real backend, remote chromium)
...
these specs gate real auth (bearer on /api/v1), slashed-DOI encoding, the
suggestion→response loop, drafts and search freshness. The legacy Argilla specs
under e2e/* are not a gate for the extraction suite.
