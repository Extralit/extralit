<template>
  <div class="pdf-upload">
    <div class="pdf-upload__section-header">
      <h3 class="pdf-upload__section-title">Step 1: Upload Full-Text PDFs</h3>
      <p class="pdf-upload__section-description">
        Upload your PDF collection to get started.<br />
        Extralit will extract metadata and create reference entries automatically.
      </p>
    </div>
