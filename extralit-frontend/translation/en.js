export default {
  ...
  datasetCreation: {
    ...
    panderaSchemaValidation: "Data Validation Schema",
    dataFrameSchema: "DataFrame Schema",
    seriesSchema: "Series Schema",
    schemaJsonEditor: "JSON Schema Editor",
    panderaSchemaJsonPlaceholder: "Enter Pandera schema as JSON...",
    columns: "Columns",
    columnName: "Column Name",
    addColumn: "Add Column",
    schemaSettings: "Schema Settings",
    strictValidation: "Strict Validation",
    coerceTypes: "Coerce Types",
    uniqueColumnNames: "Unique Column Names",
    seriesConfiguration: "Series Configuration",
    dataType: "Data Type",
    seriesName: "Series Name",
    seriesNamePlaceholder: "Optional series name",
    validationOptions: "Validation Options",
    nullable: "Allow Null Values",
    unique: "Unique Values Required",
