export default {
  ...
  question: {
    ...
    useMarkdown: "Markdownを使用",
    useTable: "テーブルを使用",
    suggestionFirst: "提案を最初に表示",
    strictSelection: "追加の提案ラベルを許可",
    visibleLabels: "表示ラベル",
    required: "必須",
    optional: "任意",
    deleteLabel: "ラベル削除",
    addNewLabel: "新しいラベルを追加...",
    addLabel: "追加",
  },
  template: "テンプレート",
  ...
  home: {
    ...
    demoLink:
      "こちらの<a href='https://huggingface.co/spaces/extralit/public-demo' target='_blank'>デモ</a>にログインしてExtralitを試してみましょう",
    name: "データセット名",
    updatedAt: "更新日",
    createdAt: "作成日",
  },
  datasetCreation: {
    ...
    createDataset: "Extralitにデータセットを作成",
    datasetName: "データセット名",
    name: "名前",
